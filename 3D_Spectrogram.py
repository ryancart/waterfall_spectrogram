...
x_tick_freqs = [0, 50, 150, 300, 500, 750, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 12000, 14000, 16000, 18000, 20000]
...
def audio_callback(indata, frames, time, status):
    ...
    samples = highpass_filter(samples, cutoff=40, fs=fs, order=2)
